...
<body>
    ...
    <div class="container py-5">
        <!-- Barra de Navegación Superior / Encabezado -->
        <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3 mb-5">
            <div>
                <h1 class="h3 text-dark fw-bold mb-1">Análisis de Demanda de Estudiantes</h1>
                <p class="text-muted small mb-0">Panel macro desarrollado en PHP para la administración de Compuedu.</p>
            </div>
            <!-- Botón para regresar al Dashboard de Spring Boot -->
            <a href="http://localhost:8080/dashboard" class="btn btn-return d-inline-flex align-items-center gap-2 shadow-sm">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-6">
                <div class="card card-custom p-4">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <span class="text-muted fw-semibold small text-uppercase tracking-wider">Postulaciones Totales</span>
            ...
            <div class="col-md-6">
                <div class="card card-custom p-4">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <span class="text-muted fw-semibold small text-uppercase tracking-wider">Área de Mayor Interés</span>
                            <h2 class="h3 fw-bold text-dark mt-2 mb-0"><?php echo htmlspecialchars($categoriaLider); ?></h2>
                        </div>
                ...
                <table class="table align-middle mb-0 table-hover">
                    ...
                    <tbody>
                        <?php if (empty($interesesGlobales)): ?>
                            <tr>
                                <td colspan="3" class="text-center py-4 text-muted">No hay filtros registrados por estudiantes aún.</td>
                            </tr>
                        <?php else: ?>
                            <?php foreach ($interesesGlobales as $interes): ?>
                                <tr>
                                    ...
                                    <td class="pe-4 text-end">
                                        <span class="badge bg-secondary bg-opacity-10 text-secondary border border-secondary border-opacity-20 px-3 py-1.5 rounded-pill">
